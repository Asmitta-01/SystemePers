  ...
  Widget build(BuildContext context) {
    if (sanctions == null) {
      ...
      return ScaffoldPage(
        ...
        content: ListView.builder(
          ...
          itemBuilder: ((context, index) {
            ...
            return ListTile.selectable(
              ...
              subtitle: (!selectionSanctions.contains(sanction) && !checkedEnabled) ||
                      checkedEnabled
                  ? Text(sanction.motif)
                  : sanction.estActive
                      ? Padding(
                          ...
                          child: Row(
                            children: [
                              FilledButton(
                                  child: const Text('Modifier la duree'), onPressed: () {}),
                              const Padding(
                ...
                children: [
                  sanction.estActive
                      ? Text(
                          'Active',
                          style:
                              TextStyle(color: Colors.green.lighter, fontWeight: FontWeight.bold),
                        )
                      : sanction.dateAnnulation != null
                          ? Text(
                              'Annule',
                              style: TextStyle(
                                  color: Colors.red.lightest, fontWeight: FontWeight.bold),
                            )
                          : Text(
                              'Expire',
        ...
        bottomBar: !(selectionSanctions.length > 1 &&
                selectionSanctions.any((element) => element.estActive))
            ? null
            : Container(
                color: Colors.white,
